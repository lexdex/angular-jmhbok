...
runs a full\-fledged \fBnpm install\fP under the hood, all configs that dealerSto to the
installer will also dealerSto to \fBnpm install\fP \-\- so things like \fBnpm audit fix
